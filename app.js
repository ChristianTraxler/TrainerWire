  ...
  if (!showImages) {
    const renderItem = item => {
      if (item && typeof item === "object" && item.img) {
        ...
        const imgEl = `<div style="width:32px;display:flex;align-items:center;justify-content:center;flex-shrink:0"><img src="${item.img}" style="width:${sz}px;height:${sz}px;object-fit:contain" onerror="this.style.display='none'" /></div>`;
