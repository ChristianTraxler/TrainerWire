...
const RAID_CP = {
  ...
  // Mega Raids
  "Mega Alakazam":{normal:"1666–1747",boosted:"2083–2184",weather:"Windy"},
  // Shadow Raids
...
function getPokemonImg(name) {
  ...
  if (lower.includes("incarnate")) {
    const m = name.match(/Incarnate\s+Forme\s+(\w+)/);
...
const CURRENT_RAID_BOSSES = {
  "1-Star Raids": [
    "Foongus (1\u2605 Raid) \u2728","Phantump (1\u2605 Raid) \u2728","Sandygast (1\u2605 Raid) \u2728","Gossifleur (1\u2605 Raid)"
  ],
  "3-Star Raids": [
    "Vileplume (3\u2605 Raid) \u2728","Dugtrio (3\u2605 Raid) \u2728","Torterra (3\u2605 Raid) \u2728"
  ],
  "5-Star Raids": [
    "Groudon (5\u2605 Raid)"
  ],
  ...
  return `<div style="animation:fadeSlideIn 0.3s ease">
    ...
    <div style="background:${th.surface};border-radius:20px;border:1.5px solid ${th.border};overflow:hidden;box-shadow:${th.shadowLg}">
      <div style="background:${th.detailHeaderBg(event.color)};padding:24px 20px;border-bottom:2px solid ${th.detailHeaderBorder(event.color)};position:relative">
        ${event.published ? `<div style="position:absolute;top:14px;right:16px;font-size:12px;color:${th.textSecondary};font-weight:600">Published ${formatPublishedDate(event.published)}</div>` : ""}
...
function render() {
  ...
  if (state.selectedEvent) {
    ...
    if (state.tab === "raids") {
      ...
      raidsTabHTML = `<div style="display:flex;flex-direction:column;gap:14px">
        <div style="font-size:${isMobile ? 10 : 11}px;color:${th.textMuted};font-weight:500;font-style:italic">Last updated on Apr 15, 2026 at 10:00 am</div>
  ...
  const tickerHTML = `<div style="overflow:hidden;white-space:nowrap;background:linear-gradient(90deg,#E74C3C,#F39C12);width:100%;position:relative;display:flex;align-items:center;min-height:${isMobile ? 28 : 32}px">
