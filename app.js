...
const TIER_EGGS = { "1-Star Raids": "assets/pokemon-images/Raid-Eggs/1-star.png", "3-Star Raids": "assets/pokemon-images/Raid-Eggs/3-star.png", "5-Star Raids": "assets/pokemon-images/Raid-Eggs/5-star.png", "Mega Raids": "assets/pokemon-images/Raid-Eggs/mega.png", "Primal Raids": "assets/pokemon-images/Raid-Eggs/5-star.png", "Shadow Raids": "assets/pokemon-images/Raid-Eggs/5-star.png", "Shadow 1-Star Raids": "assets/pokemon-images/Raid-Eggs/1-star.png", "Shadow 3-Star Raids": "assets/pokemon-images/Raid-Eggs/3-star.png", "Shadow 5-Star Raids": "assets/pokemon-images/Raid-Eggs/5-star.png", "Field Research": "assets/pokemon-images/icons/green-research.png", "Field Research (Rare)": "assets/pokemon-images/icons/green-research.png" };
let RAID_BOSS_DATA = {};
        ...
        <div style="display:flex;align-items:center;gap:14px;margin-bottom:12px;flex-wrap:wrap">
          ${(() => {
            ...
            if (event.iconImg) {
              ...
              return `<div${zoomAttrs} style="${zoomable ? "cursor:zoom-in;" : ""}width:70px;height:70px;border-radius:16px;background:${th.accentBg(event.color)};border:2px solid ${th.countdownBorder(event.color)};display:flex;align-items:center;justify-content:center;flex-shrink:0;position:relative;overflow:hidden">${shadowLayer}<img src="${event.iconImg}" style="width:62px;height:62px;object-fit:contain;position:relative;z-index:1" onerror="this.parentElement.innerHTML='${event.icon}'" />${shinySparkleDetail}${zoomHint}</div>`;
            }
