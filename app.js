...
const EVENTS = [
  ...
  { id: 117, title: "Event: July 21 – July 27 (TBA)", type: "Event", date: "2026-07-21", endDate: "2026-07-27", published: "2026-06-25", updated: "2026-06-25", lastUpdated: "June 25, 2026 at 3:42 PM", time: "Jul 21 – Jul 27", whenText: "Tuesday, July 21 to Monday, July 27, 2026 — details to be announced", color: "#8E44AD", icon: "❓", featured: false, summary: "Unannounced event window from the July Content Update calendar — type and details to be revealed.", details: { bosses: ["Details: TBA"], bonuses: ["Event listed as ??? in the July 2026 Content Update infographic"], tips: ["Check back closer to the date for full details."] } },
...
function cleanRaidLabel(name) {
  return name.replace(/^★/, "").replace(/\s*\(\d★\s*(?:Raid|Shadow Raid)?\)|\s*\(Super Mega Raid[^)]*\)|\s*\(Mega\)|\s*\(\d★\s*Max Battle.*?\)|\s*\(Research Breakthrough\)|\s*\(Field Research(?:\s*-\s*rare)?\)|\s*\(Mystery Box\)|\s*\(weekends?\)|\s*\(final week.*?\)/gi, "").replace(/\s*✨/g, "").trim();
}
