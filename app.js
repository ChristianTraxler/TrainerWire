...
const EVENTS = [
  ...
  { id: 70, title: "Community Day: August 2026", type: "Community Day", url: "https://pokemongo.com/news/save-the-date-s23", date: "2026-08-16", endDate: null, time: "2:00 PM – 5:00 PM", color: "#27AE60", icon: "\uD83C\uDF1F", updated: "2026-06-18", lastUpdated: "June 18, 2026 at 10:47 AM", featured: false, summary: "August Community Day — date confirmed, featured Pokémon to be announced.", details: { bosses: ["Featured Pokémon: TBA"], bonuses: ["Standard Community Day bonuses expected", "Exclusive move for the evolution"], tips: ["Details to be shared closer to the event.", "Save the date — announced in Season 23 preview."] } },
