...
const EVENTS = [
  ...
  { id: 92, title: "Flying Taxi: Taken Over", type: "Event", date: "2026-06-25", endDate: "2026-06-29", published: "2026-05-27", updated: "2026-06-09", lastUpdated: "June 9, 2026", time: "12:00 AM – 8:00 PM", color: "#7B68EE", icon: "🚀", iconImg: "assets/pokemon-images/icons/RocketTakeover.png", featured: true, summary: "Team GO Rocket hijacks the Flying Taxi event! Confirmed via the main Flying Taxi article: Super Rocket Radar, Mysterious Components, and Shadow Shards arrive through the GO Pass: Flying Taxi rewards track. Full Shadow lineup TBA.", details: { bosses: ["Shadow Pokémon: TBA", "Possible Shadow Legendary via Super Rocket Radar"], bonuses: ["Sub-event window: June 25 – 29", "Overlaps with the Flying Taxi main event (June 23–29, 10 AM – 8 PM local)", "Super Rocket Radar and Mysterious Components/Shadow Shards delivered through the GO Pass: Flying Taxi (per Flying Taxi article)", "Unlimited GO Points weekend: Saturday, June 27 at 12:00 AM – Monday, June 29 at 7:59 PM local time (no daily cap)", "Tier 2 Major Milestone gives bonus Stardust from defeating Team GO Rocket Grunts & Leaders", "Team GO Rocket more frequent at PokéStops and in balloons (expected)", "Full Shadow lineup announced closer to event start"], tips: ["Confirmed in the June Content Update — full Shadow lineup pending Niantic announcement.", "The Super Rocket Radar comes through the main Flying Taxi GO Pass rewards track — auto-delivered to all Trainers June 23 at 10 AM local.", "Stock up on Mysterious Components and Shadow Shards as you rank up the Flying Taxi GO Pass.", "Charged TMs typically remove Frustration during Taken Over events.", "Stack the Tier 2 Stardust bonus on every Rocket Grunt / Leader defeat during the unlimited-points weekend.", "Shadow Dialga's monthly raid run continues alongside this sub-event."], relatedNews: [{ id: 91, label: "Flying Taxi — Full Details", icon: "🚕", iconImg: "assets/pokemon-images/National-Dex/regular/Gen-9_Paldea/0931.webp" }] } },
