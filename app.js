...
function renderDetailSection(title, emoji, items, color, th, showImages) {
  ...
  if (untiered.length > 0) {
    html += `<div style="margin-bottom:12px">${tierKeys.length > 0 ? `<div style="font-size:11px;font-weight:700;color:${th.textMuted};letter-spacing:0.8px;text-transform:uppercase;margin-bottom:6px;display:flex;align-items:center;gap:6px">\uD83C\uDF3F Wild Encounters</div>` : ""}
